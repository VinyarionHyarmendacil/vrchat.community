---
title: JavaScript
preferred_title: VRChat.js
icon: JavaScript
github: vrchatapi/vrchatapi-javascript
links:
  - href: https://npmx.dev/vrchat
  - href: https://npm.im/vrchat
description: A fully-featured JavaScript SDK for the VRChat API, with first-class TypeScript support, strict typing, and built-in authentication.
---
