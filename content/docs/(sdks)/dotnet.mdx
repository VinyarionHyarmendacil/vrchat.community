...
github: vrchatapi/vrchatapi-csharp
links:
  - href: https://nuget.org/packages/vrchat.api
---
...
<Callout>
  Want to contribute to this page? [Edit it on
  GitHub](https://github.com/vrchatapi/vrchat.community/tree/main/content/docs/(sdks)/dotnet.mdx)!
</Callout>
